...
export function LeadershipTheoriesExercise() {
      ...
      <div className="exercise-wrapper" style={{ width: "100%", maxWidth: "800px", margin: "0 auto", padding: "20px 0" }}>
        <div className="start-screen-container" style={{
          ...
          <div className="start-card">
            <h2 style={{ color: '#0f172a', marginBottom: '1rem', fontSize: '1.8rem', textAlign: 'center' }}>نظريات القيادة</h2>
            <p className="exercise-instructions" style={{ marginBottom: '2rem', color: '#475569', fontSize: '1.1rem' }}>
              تعرف على نظريات القيادة المختلفة من خلال هذا التمرين.
            </p>
  ...
  return (
    <div style={{ width: "100%", maxWidth: "800px", margin: "0 auto" }}>
      <iframe
        src={`/tests/leadership-theories/index.html${participantName.trim() ? `?name=${encodeURIComponent(participantName.trim())}` : ''}`}
